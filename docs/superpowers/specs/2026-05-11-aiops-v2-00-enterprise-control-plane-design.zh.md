...
| 04a | Observability, Coroot & Debug Trace Frontend | [2026-05-11-aiops-v2-04a-observability-debug-trace-frontend-design.zh.md](2026-05-11-aiops-v2-04a-observability-debug-trace-frontend-design.zh.md) | 如何设计可观测证据、Coroot、DebugEvent、Trace Waterfall 和证据质量页面 |
| 04b | Observability, Coroot & Debug Trace Frontend TODO | [2026-05-11-aiops-v2-04b-observability-debug-trace-frontend-todo.zh.md](2026-05-11-aiops-v2-04b-observability-debug-trace-frontend-todo.zh.md) | 如何按任务落地 Observability 前端和跨 Case/OpsGraph/Verification 集成 |
...
| 05a | AI Reasoning & Prompt Trace Frontend | [2026-05-11-aiops-v2-05a-ai-reasoning-prompt-trace-frontend-design.zh.md](2026-05-11-aiops-v2-05a-ai-reasoning-prompt-trace-frontend-design.zh.md) | 如何设计 Prompt Trace、Reasoning Runs、工具可见性、输出路由和 Eval 回归页面 |
| 05b | AI Reasoning & Prompt Trace Frontend TODO | [2026-05-11-aiops-v2-05b-ai-reasoning-prompt-trace-frontend-todo.zh.md](2026-05-11-aiops-v2-05b-ai-reasoning-prompt-trace-frontend-todo.zh.md) | 如何按任务落地 AI Reasoning 前端和 Chat/Case/Approval 集成 |
...
| 06a | Execution Fabric, Runbook & Workflow Frontend | [2026-05-11-aiops-v2-06a-execution-fabric-runbook-workflow-frontend-design.zh.md](2026-05-11-aiops-v2-06a-execution-fabric-runbook-workflow-frontend-design.zh.md) | 如何设计 Tool Catalog、Runbook、Workflow Studio、运行详情、目标选择、fanout 和执行治理页面 |
| 06b | Execution Fabric, Runbook & Workflow Frontend TODO | [2026-05-11-aiops-v2-06b-execution-fabric-runbook-workflow-frontend-todo.zh.md](2026-05-11-aiops-v2-06b-execution-fabric-runbook-workflow-frontend-todo.zh.md) | 如何按任务落地 Execution Fabric 前端和 Runner/Runbook/Case 集成 |
