...
func runCLI(ctx context.Context, args []string, stdout, stderr io.Writer, now func() time.Time) int {
	...
	flags.StringVar(&llmBaseURL, "llm-base-url", os.Getenv("AIOPS_LLM_BASE_URL"), "OpenAI-compatible LLM base URL for -llm-suggestions")
	flags.StringVar(&llmAPIKey, "llm-api-key", os.Getenv("AIOPS_LLM_API_KEY"), "LLM API key for -llm-suggestions; prefer env AIOPS_LLM_API_KEY")
	flags.StringVar(&llmModel, "llm-model", os.Getenv("AIOPS_LLM_MODEL"), "LLM model for -llm-suggestions")
