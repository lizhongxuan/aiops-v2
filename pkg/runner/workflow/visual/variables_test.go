	...
	return Graph{
		...
		Nodes: []Node{
			...
			},
			{
				...
				Type:     NodeTypeAction,
				StepName: "pre",
				Step:     &workflow.Step{Name: "pre", Action: "cmd.run", Args: map[string]any{"cmd": "echo pre"}},
				Outputs: []OutputParamSpec{{
					Key:  "disk_free",
					Type: "boolean",
				}},
			},
			{
				...
				Type:     NodeTypeAction,
				StepName: "branch-a",
				Step:     &workflow.Step{Name: "branch-a", Action: "cmd.run", Args: map[string]any{"cmd": "echo a"}},
				Outputs: []OutputParamSpec{{
					Key:  "branch_a_result",
					Type: "string",
				}},
			},
			{
				...
				Type:     NodeTypeAction,
				StepName: "branch-b",
				Step:     &workflow.Step{Name: "branch-b", Action: "cmd.run", Args: map[string]any{"cmd": "echo b"}},
				Outputs: []OutputParamSpec{{
					Key:  "branch_b_result",
					Type: "string",
				}},
			...
			},
			{
				...
				Type:     NodeTypeAction,
				StepName: "verify",
				Step:     &workflow.Step{Name: "verify", Action: "cmd.run", Args: map[string]any{"cmd": "echo verify"}},
				Outputs: []OutputParamSpec{{
					Key:  "restore_lsn",
					Type: "string",
				}},
			...
			},
			{
				...
				ParentID: "loop",
				StepName: "loop-inner",
				Step:     &workflow.Step{Name: "loop-inner", Action: "cmd.run", Args: map[string]any{"cmd": "echo item"}},
				Outputs: []OutputParamSpec{{
					Key:  "item_tmp",
					Type: "string",
				}},
			},
			{
				...
				Type:     NodeTypeAction,
				StepName: "after-loop",
				Step:     &workflow.Step{Name: "after-loop", Action: "cmd.run", Args: map[string]any{"cmd": "echo after"}},
			},
		},
		Edges: []Edge{
