...
export const zhAgentUiTypeLabels: LabelMap = {
  ...
  workflow_edit_plan: "Workflow 编辑计划",
  workflow_patch_preview: "Workflow Patch 预览",
  workflow_patch_apply: "Workflow Patch 审批",
  workflow_patch_result: "Workflow Patch 结果",
  workflow_patch_validation: "Workflow Patch 校验",
  workflow_conflict: "Workflow 冲突",
  workflow_manual_candidate: "运维手册候选",
  workflow_tool_timeline: "Workflow 工具时间线",
