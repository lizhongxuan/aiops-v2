...
const NODE_DEFINITIONS = [
  ...
  },
  {
    ...
    types: ["variable_aggregator"],
    actions: ["variable.aggregate"],
    label: "变量聚合",
    category: "逻辑",
    iconText: "VAR",
    tone: "blue",
    ...
    inputs: [DEFAULT_INPUT_PORT],
    outputs: [{ id: "next", label: "下一步" }],
    description: "从上游多个候选变量中聚合出稳定输出，供后续节点引用。",
  },
  {
    key: "approval",
    types: ["approval"],
