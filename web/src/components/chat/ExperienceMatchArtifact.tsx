...
export function ExperienceMatchArtifact({ artifact }: { artifact: AiopsTransportAgentUiArtifact }) {
  return <ArtifactDetails rows={compactRows([
    { label: "命中原因", value: formatDisplayValue(pickArtifactValue(artifact, ["matchReasons", "match_reasons", "reasons", "reason"])) },
    { label: "风险", value: formatDisplayValue(pickArtifactValue(artifact, ["risks", "risk"])) },
