...
func TestResourceEndpoints(t *testing.T) {
	...
	endpoints := []struct {
		...
		{"coroot config", http.MethodGet, "/api/v1/coroot/config", http.StatusOK},
		{"coroot proxy unconfigured", http.MethodGet, "/api/v1/coroot/api/v1/services", http.StatusServiceUnavailable},
