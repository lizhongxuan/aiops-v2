...
func (c *PromptCompilerImpl) resolveConstraints(ctx CompileContext) []string {
	...
	constraints = append(constraints, "Before tool calls, group related actions into one brief progress update for substantial work; skip preambles for trivial reads and quick factual lookups.")
