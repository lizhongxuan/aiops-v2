	...
	return &tooling.StaticTool{
		Meta: tooling.ToolMetadata{
			...
			Discovery: tooling.ToolDiscoveryMetadata{
				...
				DiscoveryTags:     []string{"manual", "runbook", "preflight", "probe"},
				CapabilityKind:    "preflight",
				ResourceTypes:     []string{"manual", "runbook", "preflight", "procedure"},
				OperationKinds:    []string{"preflight", "read"},
				RequiresSelect:    true,
