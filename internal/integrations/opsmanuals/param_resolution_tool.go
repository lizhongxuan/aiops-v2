	...
	return &tooling.StaticTool{
		Meta: tooling.ToolMetadata{
			...
			Discovery: tooling.ToolDiscoveryMetadata{
				...
				DiscoveryTags:     []string{"manual", "runbook", "parameter", "resolution"},
				CapabilityKind:    "parameter_resolution",
				ResourceTypes:     []string{"manual", "runbook", "parameter", "procedure"},
				OperationKinds:    []string{"resolve", "read"},
				RequiresSelect:    true,
